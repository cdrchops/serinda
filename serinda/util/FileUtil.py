...
with open(ApplicationConstants.serindaCommands2JsonFile, 'w', encoding='utf-8') as out_file:
    # read every line. We give open() the encoding so it will return a Unicode string.
    for line in open(ApplicationConstants.serindaCommandsJsonFile, encoding='utf-16'):
