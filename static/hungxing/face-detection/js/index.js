...
function startCamera() {
    if (streaming) return;
    /*
    navigator.mediaDevices.getUserMedia({video: resolution, audio: false, deviceId: deviceId})
    .then(function(s) {
      stream = s;
      video.srcObject = s;
      video.play();
    ...
    var deviceId = 'f987dd7c8a8ddb5003176852f8bcb5254f9eac9b0c9e73b67a76373197b54f6d';
    // or facingMode: 'user'
